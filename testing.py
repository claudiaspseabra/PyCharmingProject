...
print("Average response time por police department:\n",average_response_time)
plt.show()

ax = sns.countplot(x="Police District Name", data=crime, hue="Police District Name", palette="Blues", legend=False)

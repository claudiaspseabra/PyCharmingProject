...
plt.ylabel("Actual")
plt.title("Confusion Matrix - Decision Tree Classification (Crime Type)")
plt.show()

plt.figure(figsize=(20, 10))
plot_tree(dt_clf, feature_names=X.columns, class_names=[str(cls) for cls in sorted(y.unique())], filled=True)
plt.title("Decision Tree - Crime Classification")
plt.show()
...
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.title("Confusion Matrix - Decision Tree with PCA (Crime Type)")
plt.show()

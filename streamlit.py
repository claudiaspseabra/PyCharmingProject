...
- [Advanced Feature Engineering](#2-advanced-feature-engineering)
...
if crime is not None:
    ...
    **Incident ID:** A unique identifier for each crime incident.
    ...
    st.write("acho que aqui podiam ter uns gráficos para duration crime")
    ...
    # GRAPH: Victims Distribution per Crime Type
    ...
    # GRAPH: Average Number of Victims per Crime
    ...
    st.subheader("Análise dos Crimes")

    # 1. Distribution of Crime Type in numbers
    ...
    st.subheader("Análise da ocorrência e horário dos crimes")
    ...
    # 8. Monthly Crime Distribution by Years
    fig = plt.figure(figsize=(10, 6))
    crimeByMonth = sns.countplot(data=crime, x='Month')
    crimeByMonth.set(ylabel='Crimes')
    plt.title("Monthly Crime Distribution")
    ...
    st.subheader("Análise da localização dos crimes")
    ...
    colors = sns.color_palette("deep")[6:11]
    ...
    # 18. Crime Type Distribution for Each Police District
